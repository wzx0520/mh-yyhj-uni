...
<template>
  <view class="page-wrap">
    <uni-nav-bar :title="title" leftIcon="left" :border="false" :statusBar="true" :fixed="true"
    ...
    <view class="form-item default">
      <view class="form-item-content">
        ...
        <view class="right">
          <evan-switch v-model="formData.status" active-color="#00e1db" :size="24" :active-value="1"
